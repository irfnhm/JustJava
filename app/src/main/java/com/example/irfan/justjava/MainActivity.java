package com.example.irfan.justjava;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void submitOrder(View view) {
        ...
        EditText editTextName = (EditText) findViewById(R.id.name_edit_text);
        ...
        //disable editext after order is placed.
    ...
    private int calculatePrice(boolean hasWhippedCream, boolean hasChocolate) {
        if(hasWhippedCream == true && hasChocolate == true){
            ...
            return ((quantity * 5) + whippedCream);
        }
        else if (hasWhippedCream == false && hasChocolate == true){
            return ((quantity * 5) + chocolate);
        }
        else{
            return (quantity * 5);
        }
